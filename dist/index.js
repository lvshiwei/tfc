 ...
 * YUP合法的指令集
 */
var YUP_TYPE_LIST = ["string", "number", "bool", "date", "mixed", "array"];
var SUGAR_VARIABLES = _defineProperty({}, "$TODAY", new Date());
...
function generateFormUI (schema) {
  ...
  for (var key in schema) {
    ...
    var itemComp = t.jsxElement(t.jsxOpeningElement(item, [t.jsxAttribute(t.jsxIdentifier("name"), t.stringLiteral(key)), t.jsxAttribute(t.jsxIdentifier("onChange"), t.jsxExpressionContainer(t.callExpression(t.identifier("handleChangeInput"), [t.stringLiteral(key)])))]), t.jsxClosingElement(item), []);
